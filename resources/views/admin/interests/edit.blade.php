...
@section('pageTitle', 'Interest Edit')
...
<div class="card card-default">
    ...
    <h3 class="card-title">@yield('pageTitle')</h3>
        ...
        <div class="card-tools">
            <a href="{{ route('admin.interests') }}" class="btn btn-success"><i class="fas fa-arrow-circle-left"></i> Back</a>
        </div>
    </div>
    <!-- /.card-header -->
    <form role="form" action="{{ route('admin.interest-update', ['interest' => $interest->id]) }}" method="POST">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select name="status" class="form-control select2" style="width: 100%;">
                        <option value="0" @if(old('status', $interest->status) == '0') selected @endif>In-Active</option>
                        <option value="1" @if(old('status', $interest->status) == '1') selected @endif>Active</option>
                    </select>
                </div>
            </div>
