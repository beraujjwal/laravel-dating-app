...
<div class="card card-default">
    ...
    <!-- /.card-header -->
    <form role="form" action="{{ route('admin.agegroup-update', ['agegroup' => $agegroup->id]) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="gender" class="form-control select2" style="width: 100%;">
                        @foreach($genders as $gender)
                            <option value="{{ $gender->id }}" @if(old('gender', $agegroup->gender_id) == $gender->id) selected @endif>{{ $gender->name }}</option>
                        @endforeach
                    </select>
